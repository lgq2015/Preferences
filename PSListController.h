...
@interface PSListController : PSViewController <UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate, UIAlertViewDelegate, UIPopoverControllerDelegate> {
...
-(void)presentViewController:(id)conttroller animated:(BOOL)animated completion:(id)completion;
@end
